...
<div class="page-body">
    <div class="card">
        <div class="card-header">
            <h5>Tambah Motor</h5>
            <span>Form untuk menambahkan data motor baru</span>
        </div>
        <div class="card-body">
            <form action="{{ route('motor.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_motor" class="form-control @error('nama_motor') is-invalid @enderror" id="nama_motor" value="{{ old('nama_motor') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="harga_jual" class="form-control @error('harga_jual') is-invalid @enderror" id="harga_jual" value="{{ old('harga_jual') }}" required>
                 ...
                 <div class="form-group">
                    ...
                    <textarea name="deskripsi_motor" class="form-control @error('deskripsi_motor') is-invalid @enderror" id="deskripsi_motor" required>{{ old('deskripsi_motor') }}</textarea>
                 ...
                 <div class="form-group">
                    ...
                    <textarea name="warna" class="form-control @error('warna') is-invalid @enderror" id="warna" required>{{ old('warna') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kapasitas_mesin" class="form-control @error('kapasitas_mesin') is-invalid @enderror" id="kapasitas_mesin" value="{{ old('kapasitas_mesin') }}" required>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="number" name="stok" class="form-control @error('stok') is-invalid @enderror" id="stok" value="{{ old('stok') }}" required>
